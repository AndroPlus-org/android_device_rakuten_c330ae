...
TW_OVERRIDE_SYSTEM_PROPS := "ro.product.device;ro.build.product;ro.build.fingerprint;ro.build.version.sdk;ro.build.version.security_patch;ro.build.version.release"
